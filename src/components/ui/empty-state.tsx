...
import { SenegalDots } from './senegal-accents'
  ...
  return (
    <div className="flex flex-col items-center justify-center py-14 px-6 text-center">
      <div className="w-10 h-10 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center mb-4">
        <svg className="w-5 h-5 text-emerald-600/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <SenegalDots className="mt-5 opacity-40" />
    </div>
  )
}
